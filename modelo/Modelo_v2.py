...
class Modelo(nn.Module):
    def __init__(self, src_tok_emb: tesrc, nhead: int, num_layers: int, emb_size: int, dropout: float):
...
modelo = Modelo(src_tok_emb=src_tok_emb, nhead=nhead, num_layers=num_layers, emb_size=emb_size, dropout=dropout)
